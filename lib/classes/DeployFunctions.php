...
class DeployFunctions {
    ...
    public function deployServiceSchema($ownerName, $password) {
        ...
        // Create indexes
        $sqlIndexes = [];
        $sqlIndexes['RECORD_POOL_PATIENT_IDX'] = "CREATE UNIQUE INDEX RECORD_POOL_PATIENT_IDX ON $ownerName.RECORD_POOL (ID_PATIENT,ID_EPISODE,ID_OPERATION)";
        $sqlIndexes['RECORD_POOL_CHANGED_IDX'] = "CREATE INDEX RECORD_POOL_CHANGED_IDX ON $ownerName.RECORD_POOL (CHANGED)";
        $sqlIndexes['RECORD_POOL_ADMISSION_DATE_IDX'] = "CREATE INDEX RECORD_POOL_ADMISSION_DATE_IDX ON $ownerName.RECORD_POOL (ID_PATIENT,ADMISSION_DATE)";
        $sqlIndexes['RECORD_POOL_EPISODE_IDX'] = "CREATE INDEX RECORD_POOL_EPISODE_IDX ON $ownerName.RECORD_POOL (ID_PATIENT,ID_EPISODE)";
        $sqlIndexes['PROCESS_HISTORY_DATE_IDX'] = "CREATE INDEX PROCESS_HISTORY_DATE_IDX ON $ownerName . PROCESS_HISTORY(START_DATE, PROCESS_NAME)";
        $sqlIndexes['PROCESS_LOG_IDX'] = "CREATE INDEX PROCESS_LOG_IDX ON $ownerName . PROCESS_LOG(ID_PROCESS)";
